...
public class OrdersFunctions
{
    ...
    {
        _conn = cfg["StorageConnection"] ?? throw new InvalidOperationException("AzureStorage connection string missing");
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "orders")] HttpRequestData req)
    {
        ...
        // Snapshot price & reduce stock (naive; for concurrency use ETag preconditions)
